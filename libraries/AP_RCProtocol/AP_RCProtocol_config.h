...
#ifndef AP_RCPROTOCOL_MAVLINK_RADIO_MASKED_ENABLED
#define AP_RCPROTOCOL_MAVLINK_RADIO_MASKED_ENABLED AP_RCPROTOCOL_BACKEND_DEFAULT_ENABLED && HAL_PROGRAM_SIZE_LIMIT_KB > 1024 && HAL_GCS_ENABLED
#endif
